  <form id="ova-upload">                
	...
	<input type="file" class="ova-file" onchange='window.selectorScript("http://www.ocl.dev/api/teacher/upload/chunkupload", )' id="ova-file"><span><em>(OVA must match machine name)</em></span>
	<div class="progress">
